    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{ asset("mobileconfig/udid.mobileconfig") }}">
                        تحميل المتجر
                    </a>
                </li>
...
{{--<string>https://6798f506c1f7.ngrok.io/storage/mobileconfig/udid.php</string>--}}
{{--<string>https://bo4.co/storage/mobileconfig/udid.php</string>--}}
